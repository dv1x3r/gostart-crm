...
func (s *Service) Fetch(ctx context.Context, r w2.GridDataRequest) ([]OrderStatus, int, error) {
	const op = "orderstatus.Service.Fetch"
...
func (s *Service) Reorder(ctx context.Context, r w2.GridReorderRequest) error {
	...
	if err := w2sort.ReorderArray(ids, r); err != nil {
		return wrap.IfErr(op, ErrOrderStatusInvalidReorder)
	}
