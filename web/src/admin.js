...
import { createOrderLayout, openOrderStatusPopup, openPaymentMethodPopup } from './admin/order'
  ...
  panels: [
    {
      type: 'top', size: 40, toolbar: {
        items: [
          ...
          { type: 'spacer' },
          { type: 'button', id: 'client', text: 'htmx/alpine demo', icon: 'fa fa-arrow-right-to-city', onClick: () => window.open('/client', '_blank') },
          { type: 'button', id: 'github', text: 'GitHub Project', icon: 'fa-brands fa-github', onClick: () => window.open('https://github.com/dv1x3r/gostart-crm', '_blank') },
