  ...
  panels: [
    {
      type: 'top', size: 40, toolbar: {
        items: [
          ...
          { type: 'spacer' },
          { type: 'button', id: 'client', text: 'Frontend Client Demo', icon: 'fa fa-arrow-right-to-city', onClick: () => window.open('/client', '_blank') },
          { type: 'button', id: 'weasel', text: 'weasel.dev', icon: 'fa fa-arrow-right-to-city', onClick: () => window.open('https://weasel.dev', '_blank') },
