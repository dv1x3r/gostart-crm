...
export function createOrderLayout() {
  ...
  const orderForm = new w2form({
    ...
    fields: [
      ...
      { field: 'status', html: { label: 'Status', span: 4, column: 0, group: 'Status and Payment' }, type: 'list', options: utils.getSelectOptions('/order/status/dropdown'), required: true },
      { field: 'payment', html: { label: 'Payment', span: 4, column: 0 }, type: 'list', options: utils.getSelectOptions('/order/payment/dropdown'), required: true },
      { field: 'created_at', html: { label: 'Created at', span: 4, column: 1, group: 'System', attr: 'readonly' }, type: 'datetime' },
      { field: 'updated_at', html: { label: 'Updated at', span: 4, column: 1, attr: 'readonly' }, type: 'datetime' },
      { field: 'delivery_address', html: { label: '', span: 0, column: 0, group: 'Delivery Address', attr: 'style="width: 100%; height: 70px; resize: none;" readonly' }, type: 'textarea' },
      { field: 'comment', html: { label: '', span: 0, column: 1, group: 'Order Comment', attr: 'style="width: 100%; height: 70px; resize: none;" readonly' }, type: 'textarea' },
      ...
      { field: 'language', html: { label: 'Language', span: 4, column: 1, group: 'Management Notes', attr: 'style="width: 100%;' }, type: 'text', required: true },
      { field: 'notes', html: { label: '', span: 0, column: 1, attr: 'style="width: 100%; height: 107px; resize: none;"' }, type: 'textarea' },
    ],
    actions: {
      async Save() {
